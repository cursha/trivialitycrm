// No `import "server-only"` — salesListVisibilityWhere is needed by
// src/lib/campaigns/queries.ts, which the run-campaign-step/
// campaign-step-tick worker handlers need too; that guard throws under
// plain Node/tsx execution. Every consumer is itself a server-only
